    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Guru</h3>
                <p class="text-subtitle text-muted">Menampilkan semua Guru yang terdaftar dalam sistem</p>
            </div>
...
@push('additional-js')
    <script>
        ...
        $(document).ready(function() {
            ...
            function simpan(id = '') {
                if (id == '') {
                    var var_url = '{{ route('guru.store') }}';
                    var var_type = 'POST'
                } else {
                    var var_url = '{{ route('guru.update', ':id') }}'.replace(':id', id);
                    var var_type = 'PUT'
                }
            ...
            $('body').on('click', '.tombol-edit', function(e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url: '{{ route('guru.edit', ':id') }}'.replace(':id', id),
                    type: 'GET',
                    success: function(response) {
                        $('#exampleModalLabel').html('Form Edit Guru')
                        $('#exampleModal').modal('show');
            ...
            //  handler ini akan memunculkan modal konfirmasi dan mengirimkan data-i ke tombol-hapus di  modal konfirmasi hapus
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="">
                                        <label for="invalid-state">Nama Guru</label>
